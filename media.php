...
<div id="wrapper_sec">
	...
	<!--  <div class="logo">
            ...
            <!--<p class="bold right"><a id="various1" href="#inline1"><input style='width: 93px; height: 36px;' class= tombol2 ></a></p>-->
          <div class="clear">
          </div>
      <br><br><br>
        <div class="clear"><div class="rightnavi">
		<span class="style_waktu"><ul><SCRIPT language=JavaScript src="almanak.js"></SCRIPT> 
          I <SCRIPT language=JavaScript>var d = new Date();
var h = d.getHours();
...
while($b=mysql_fetch_array($header)){
  echo "<li><img width=680 src='header/$b[gambar]'></li>";
...
<div class="small_heading">
        	 ...
        	 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <iframe src="//www.facebook.com/plugins/likebox.php?href=http%3A%2F%2Fwww.facebook.com%2FLintasWarnaEventOrganizer&amp;
width=300&amp;height=400&amp;colorscheme=light&amp;show_faces=true&amp;
header=true&amp;stream=false&amp;show_border=true" scrolling="no" frameborder="0" style="border:0; overflow:hidden; width:200px; height:370px;" allowTransparency="true"></iframe>
...
?>
    ...
    <div id="footer">
        <div class="aboutus">
			...
			<ul>
        	 <li class="email"><span class="bold">Email:</span> <a href="mailto:rahmadewifurniture@yahoo.com">rahmadewifurniture@yahoo.com</a></li>
            </ul>	
        </div>
        ...
        <div class="joinnews">
        	...
        	<ul>
            	<li class="tel"><span class="bold">Tel:</span> 085 325 222 010 </li>
            </ul>
        </div>
        <div class="joinnews">
        	
            <ul>
                <li><span class="bold">Showroom:</span> Jl Soekarno Hatta BokBiru Rt 02/Rw 04 Tahunan Jepara</li>
            </ul>
