...
switch($_GET[act]){
  // Tampil Warna Finishing
  default:
    $sql  = mysql_query("SELECT * FROM modul WHERE id_modul='69'");
    $r    = mysql_fetch_array($sql);

    echo "<h2>Warna Fisishing</h2>
          <form method=POST action=$aksi?module=warna&act=update>
