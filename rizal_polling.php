...
echo "<div class='category'>";
  ...
  $poling=mysql_query("SELECT * FROM poling WHERE aktif='Y' and status='Jawaban'");
	...
	echo "<tr><p style='padding-left:5px;padding-right:55px;'><input type=radio name=pilihan value='$p[id_poling]' />&nbsp;<span class='idtanggal'>$p[pilihan]</p></tr>";
  }
  echo "<tr><p style='padding-left:10px;padding-right:5px;padding-top:5px ;'>
		<input type=submit class=simplebtn  value=PILIH />
		<a href=lihat-poling.html><input type=submit class=simplebtn  value=LIHAT HASIL /></a></p></tr>
        </form>";
