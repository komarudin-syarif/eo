...
elseif ($_GET[module]=='detailproduk'){
	...
	echo"<div class='feat_prod_box_details'>";
 	if ($d[gambar]!=''){
		echo "<div class='prod_img3'><a href='foto_produk/$d[gambar]' rel='clearbox[gallery=Koleksi Produk]' 
		title='$d[nama_produk]'><img src='foto_produk/$d[gambar]' width=180  class='tooltip' 
		title='klik untuk memperbesar gambar' border='0' rel='clearbox[gallery=Koleksi Produk]' title='$d[nama_produk]'/></a>
...
// Modul cara pembayaran
if ($_GET['module']=='carabayar'){
  // Data cara pembelian mengacu pada id_modul=66
	$cara = mysql_query("SELECT * FROM modul WHERE id_modul='66'");
	$r      = mysql_fetch_array($cara);

  echo "<h4 class='heading colr'>Cara Pembayaran</h4>
...
// Modul Pengiriman
if ($_GET['module']=='kirim'){
  // Data cara pembelian mengacu pada id_modul=67
	$cara = mysql_query("SELECT * FROM modul WHERE id_modul='67'");
	$r      = mysql_fetch_array($cara);

  echo "<h4 class='heading colr'>Pengiriman</h4>
...
// Modul Info
if ($_GET['module']=='info'){
  // Data cara pembelian mengacu pada id_modul=68
	$cara = mysql_query("SELECT * FROM modul WHERE id_modul='68'");
	$r      = mysql_fetch_array($cara);

  echo "<h4 class='heading colr'>Info</h4>
...
// Modul Warna Finishing
if ($_GET['module']=='warna'){
  // Data cara pembelian mengacu pada id_modul=69
	$cara = mysql_query("SELECT * FROM modul WHERE id_modul='69'");
	$r      = mysql_fetch_array($cara);

  echo "<h4 class='heading colr'>Warna Finishing</h4>
...
elseif ($_GET[module]=='keranjangbelanja'){
  ...
  <tr><td colspan=6 align=right><br><span class='table3'>Total:</td><td colspan=2><br><span class='table3'><?php echo "Rp. $total_rp,-"?></b></td></tr>
        <tr><td colspan=2><br />
		<a href=store><input style='width: 135px; height: 22px;' class= simplebtn value='LANJUTKAN BELANJA'></a><br /></td>
        <td colspan=2><br /><input style='width: 130px; height: 22px;'  class= simplebtn value='UPDATE KERANJANG'><br /></td>
        <td colspan=4 align=right><br /><a href=selesai-belanja.html>
		<input style='width: 115px; height: 22px;' class= simplebtn value='SELESAI BELANJA'><br /></td></tr>
        </tbody>
  </table>
<?php echo "<br /><br /><br /><br /><p>*   Apabila Anda mengubah jumlah (Qty), jangan lupa tekan tombol <b>Update Keranjang</b><br />
...
/*echo "<h4 class='heading colr'>Pembeli Lama</h4>";
    	  echo "
      ...
      <tr><td><span class='table4'>Password</td><td>  <input type=password name=password size=30 class='table5'></td></tr>
      <tr><td><input style='width: 60px; height: 25px;' type='submit' class='simplebtn' value='Login'></td><td align=left><a href='lupa-password.html'>Lupa Password?</a></td></tr>
      </table>
      </form>";
*/
  echo "<h4 class='heading colr'>Data Pembeli</h4>
	  ...
	  <!--<tr><td><span class='table4'>Password</td><td> <input type=text name=password class='table5'></td></tr>-->
...
//END nampilkan diskon per produk --
  ...
  echo "<tr><td></td><td></td><!--<td colspan=2 align=right><span class='table3'>Total Berat:</td><td align=center><span class='table3'>$totalberat kg</b></td>-->
...
while ($d=mysql_fetch_array($daftarproduk)){
   ...
   echo "<tr background='images/bg_tab2.jpg' align=center height=23><td>$no</td><td>$d[nama_produk]</td><!--<td align=center><?php $d[berat] ?></td>--><td align=center>$d[jumlah]</td><td>Rp. $harga,-</td><td>Rp. $subtotal_rp,-</td></tr>";
...
$pesan.="<br /><br />Total : Rp. $total_rp,-
         ...
         <br /><br />Silahkan lakukan pembayaran ke Bank BNI sebanyak Grand Total yang tercantum, nomor rekeningnya <b>0173153710</b> a.n. Akhmad Luqman Wibowo";
...
mail("luqman@artfurniture.com",$subjek,$pesan,$dari);
...
echo "<tr><td colspan=4 align=right>Total : Rp. </td><td align=right><b>$total_rp</b></td></tr>
      <tr><td colspan=4 align=right>Ongkos Kirim untuk Tujuan Kota Anda: Rp. </td><td align=right><b>$ongkoskirim1_rp</b></td></tr>      
	    <!--<tr><td colspan=4 align=right>Total Berat : </td><td align=right><b><?php// $totalberat?> Kg</b></td></tr>-->
